...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "冷脚本"; Text ="感谢小玄奘提供的功能"; Duration = 1; })
 wait(2)
local bin = {
    playernamedied = "",
    dropdown = {}
...
local creds = window:Tab("帮助榜", "6031097229")
...
local creds = window:Tab("出生榜", "6031097229")
local about = creds:section("信息", true)
...
local creds = window:Tab("加入服务器", "6031097229")
local about = creds:section("信息", true)
...
local creds = window:Tab("复制", "6031097229")
local about = creds:section("信息", true)
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/XiaoFenHG/Dex-Explorer/refs/heads/main/Dex-Explorer.lua"))()
   ...
   about:Toggle("第四章透视","MainStorage",false,function(state)
    ...
    local creds = window:Tab("传送玩家", "7734068321")
...
local creds = window:Tab("娱乐+反作弊绕过", "7734068321")
...
game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack(args))
    ...
    local creds = window:Tab("娱乐+移除模型", "7734068321")
...
local creds = window:Tab("自动化", "7734068321")
...
local creds = window:Tab("透视", "7734068321")
